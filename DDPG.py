...
if __name__=='__main__':
    ...
    for seed in args.random_seed_list:
        ...
        if args.train:
            ...
            while collect_data:
                ...
                with torch.no_grad():
                    trajectory=agent.explore_env(env,target_step,if_gail = False)
    ...
    with open(r'E:\pyProject\Energy-System\DRL-for-Energy-Systems-Optimal-Scheduling-main\DRL-for-Energy-Systems-Optimal-Scheduling-main\AgentDDPG\test_data.pkl', "rb") as f:
    ...
    df.to_csv(r'E:\document\Matlab R2022a\test_data_DDPG.csv')
    
    with open(r'E:\pyProject\Energy-System\DRL-for-Energy-Systems-Optimal-Scheduling-main\DRL-for-Energy-Systems-Optimal-Scheduling-main\AgentDDPG\loss_data.pkl', "rb") as f:
        object = pickle.load(f, encoding='latin1')
    df = pd.DataFrame(pd.DataFrame.from_dict(object, orient='index').values.T, columns=list(object.keys()))
    df.to_csv(r'E:\document\Matlab R2022a\loss_data_DDPG.csv')
    
    with open(r'E:\pyProject\Energy-System\DRL-for-Energy-Systems-Optimal-Scheduling-main\DRL-for-Energy-Systems-Optimal-Scheduling-main\AgentDDPG\reward_data.pkl', "rb") as f:
        object = pickle.load(f, encoding='latin1')
    df = pd.DataFrame(pd.DataFrame.from_dict(object, orient='index').values.T, columns=list(object.keys()))
    df.to_csv(r'E:\document\Matlab R2022a\reward_data_DDPG.csv')
